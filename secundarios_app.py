...
    # ALTERAÇÃO 1: Inicializa com uma lista vazia para não ter papéis de exemplo
...
    df_papeis = pd.DataFrame(columns=['Emissor', 'Ticker', 'Valor', 'Tipo', 'Taxa', 'Data Vencimento'])
    # ALTERAÇÃO 2: A linha abaixo foi REMOVIDA para não preencher com o 'Emissor Exemplo'
...
    # Esta mensagem será exibida quando a calculadora iniciar, pois a lista de papéis está vazia.
